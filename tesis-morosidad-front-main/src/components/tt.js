...
export default function Resultado(){
    ...
    const loadData = async () => {
      try {
        ...
        fetch('http://localhost:4000/region') // Reemplaza con la ruta correcta
        .then((response) => response.json())
        .then((data) => setDataRegion(data))
        .catch((error) => console.error('Error al cargar datos de región:', error));

        fetch('http://localhost:4000/distrito') // Reemplaza con la ruta correcta
          .then((response) => response.json())
        ...
        fetch('http://localhost:4000/usuario') // Reemplaza con la ruta correcta
          .then((response) => response.json())
        ...
        fetch('http://localhost:4000/estado') // Reemplaza con la ruta correcta
          .then((response) => response.json())
        ...
        fetch('http://localhost:4000/educativo') // Reemplaza con la ruta correcta
          .then((response) => response.json())
        ...
        fetch('http://localhost:4000/motivo') // Reemplaza con la ruta correcta
          .then((response) => response.json())
        ...
        // fetch('http://localhost:4000/clientes') // Reemplaza con la ruta correcta
        // .then((response) => response.json())
